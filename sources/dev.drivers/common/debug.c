    ...
    if ((fPutC != NULL_PTR) && (fmt_in != NULL_PTR) && (args_in != NULL_PTR))
    {
        ...
        for(;;)
        {
            ...
            switch (f)
            {
                ...
                float temp = fval - (float)ipart;
                sint32 multiplier = 1;
                for (i = 0; i < precision; i++) {
                    multiplier *= 10;
                }
                fpart = (sint32)(temp * (float)multiplier + 0.5f);
                ...
                length = DBG_Print10((uint32)ipart, str);
                str += length;
                ...
                *str = '.';
                ...
                temp_len = DBG_Print10((uint32)fpart, temp_str);
                
                for (i = 0; i < (precision - temp_len); i++) {
                    *str = '0';
                    str++;
                    length++;
                }
